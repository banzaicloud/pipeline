...
import (
	...
	pcluster "github.com/banzaicloud/pipeline/pkg/cluster"
...
func errorResponseFrom(err error) *common.ErrorResponse {
	...
	if err == perrors.ErrorNotSupportedCloudType {
		return &common.ErrorResponse{
			Code:    http.StatusBadRequest,
			Error:   err.Error(),
			Message: err.Error(),
