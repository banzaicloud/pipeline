...
// MockOrganizationMembershipStore is an autogenerated mock type for the OrganizationMembershipStore type
type MockOrganizationMembershipStore struct {
	mock.Mock
}

// AddUserTo provides a mock function with given fields: ctx, organizationName, userID, role
func (_m *MockOrganizationMembershipStore) AddUserTo(ctx context.Context, organizationName string, userID uint, role string) error {
...
func (_m *MockOrganizationMembershipStore) GetOrganizationMembershipsOf(ctx context.Context, userID uint) ([]UserOrganization, error) {
...
func (_m *MockOrganizationMembershipStore) RemoveFromOrganization(ctx context.Context, organizationID uint, userID uint) error {
...
func (_m *MockOrganizationMembershipStore) UpdateUserMembership(ctx context.Context, organizationID uint, userID uint, role string) error {
