...
type secretStore interface {
	Get(organizationID uint, secretID pkgSecret.SecretID) (*secret.SecretItemResponse, error)
}
...
func (v *secretValidator) ValidateSecretType(organizationID uint, secretID pkgSecret.SecretID, provider string) error {
