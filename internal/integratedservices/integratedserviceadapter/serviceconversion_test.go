...
type specExtracterStub struct {
	mappedSpec  integratedservices.IntegratedServiceSpec
	mappedError error
}

func (f specExtracterStub) ConvertSpec(ctx context.Context, service v1alpha1.ServiceInstance) (integratedservices.IntegratedServiceSpec, error) {
