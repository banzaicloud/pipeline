...
// MockK8sHealthChecker is an autogenerated mock for the K8sHealthChecker type.
type MockK8sHealthChecker struct {
	mock.Mock
}

// Check provides a mock function.
func (_m *MockK8sHealthChecker) Check(ctx context.Context, client kubernetes.Interface) (_result_0 error) {
