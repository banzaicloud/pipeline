...
// PKEAWS ClusterModel describes the EKS cluster model
type PKEAWSClusterModel struct {
...
// TableName sets PKEAWSClusterModel's table name
func (PKEAWSClusterModel) TableName() string {
	return "amazon_eks_clusters"
}

// AfterUpdate removes marked node pool(s)
func (cm *PKEAWSClusterModel) AfterUpdate(tx *gorm.DB) error {
...
func (cm *PKEAWSClusterModel) SetCurrentWorkflowID(workflowID string) error {
...
func (cm *PKEAWSClusterModel) PersistSSHGenerate(sshGenerated bool) error {
...
func (cm PKEAWSClusterModel) IsSSHGenerated() bool {
	return cm.SSHGenerated
}

func (cm PKEAWSClusterModel) String() string {
...
type AmazonNodePoolsModel struct {
	...
	Status           pke.NodePoolStatus // Note: stored status info is only used when CF stack is not existing.
