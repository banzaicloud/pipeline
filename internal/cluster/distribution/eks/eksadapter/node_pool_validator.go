...
func NewNodePoolValidator(db *gorm.DB, spotPriceValidator SpotPriceValidator) nodePoolValidator {
...
func (v nodePoolValidator) ValidateNewNodePool( // TODO: rename ValidateNodePoolCreate.
	ctx context.Context,
	c cluster.Cluster,
