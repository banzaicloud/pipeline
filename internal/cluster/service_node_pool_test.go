...
func TestNodePoolService_CreateNodePool(t *testing.T) {
	t.Run("ClusterNotFound", func(t *testing.T) {
		...
		err := service.CreateMultiNodePools(ctx, 1, []NewRawNodePool{rawNewNodePool})
		require.Error(t, err)
	...
	t.Run("CreateNodePoolError", func(t *testing.T) {
		...
		distributionService.On("CreateMultiNodePools", ctx, cluster.ID, []NewRawNodePool{rawNewNodePool}).
	...
	t.Run("Success", func(t *testing.T) {
		...
		distributionService := new(MockService)
		distributionService.On("CreateMultiNodePools", ctx, cluster.ID, []NewRawNodePool{rawNewNodePool}).Return(nil)
