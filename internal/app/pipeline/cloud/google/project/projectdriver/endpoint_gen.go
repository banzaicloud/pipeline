...
const (
	ListProjectsEndpoint = "project.ListProjects"
)
...
func MakeEndpoints(service project.Service, middleware ...endpoint.Middleware) Endpoints {
	...
	return Endpoints{ListProjects: kitxendpoint.OperationNameMiddleware(ListProjectsEndpoint)(mw(MakeListProjectsEndpoint(service)))}
}
