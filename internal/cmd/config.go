...
func Configure(v *viper.Viper, p *pflag.FlagSet) {
	...
	v.SetDefault("cluster::logging::charts::operator::version", "3.1.0")
	...
	v.SetDefault("cluster::logging::images::operator::tag", "3.1.0")
	v.SetDefault("cluster::logging::charts::loggingDemo::chart", "banzaicloud-stable/logging-demo")
	v.SetDefault("cluster::logging::charts::loggingDemo::version", "3.1.0")
	v.SetDefault("cluster::logging::charts::loggingDemo::values", map[string]interface{}{})
