...
func (o outputPrometheus) getOutputType() string {
	return "Prometheus"
}

func (o outputPrometheus) getTopLevelDeploymentKey() string {
	return "prometheus"
}

func (o outputPrometheus) getDeploymentValueParentKey() string {
	return "prometheusSpec"
}

func (o outputPrometheus) getGeneratedSecretName(clusterID uint) string {
