...
func (_m *MockService) InstallRelease(ctx context.Context, organizationID uint, clusterID uint, releaseInput Release, options Options) (release Release, err error) {
	ret := _m.Called(ctx, organizationID, clusterID, releaseInput, options)

	var r0 Release
	if rf, ok := ret.Get(0).(func(context.Context, uint, uint, Release, Options) Release); ok {
		r0 = rf(ctx, organizationID, clusterID, releaseInput, options)
	} else {
		r0 = ret.Get(0).(Release)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, uint, uint, Release, Options) error); ok {
		r1 = rf(ctx, organizationID, clusterID, releaseInput, options)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockService) UpgradeRelease(ctx context.Context, organizationID uint, clusterID uint, releaseInput Release, options Options) (release Release, err error) {
	ret := _m.Called(ctx, organizationID, clusterID, releaseInput, options)
