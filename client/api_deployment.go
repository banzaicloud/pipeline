...
/*
DeploymentApiService Get deployment K8s images
...
*/
func (a *DeploymentApiService) GetDeploymentImages(ctx context.Context, orgId int32, id int32, name string) (DeploymentImageList, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
