...
func (r ApiGetServicesRequest) Execute() (*ServicesResponse, *http.Response, error) {
...
*/
func (a *ServicesApiService) GetServices(ctx context.Context, provider string) ApiGetServicesRequest {
	return ApiGetServicesRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
func (a *ServicesApiService) GetServicesExecute(r ApiGetServicesRequest) (*ServicesResponse, *http.Response, error) {
	var (
