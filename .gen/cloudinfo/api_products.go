...
*/
func (a *ProductsApiService) GetProducts(ctx _context.Context, provider string, service string, region string) (ProductDetailsResponse, *_nethttp.Response, error) {
	var (
