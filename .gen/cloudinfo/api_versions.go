...
func (r ApiGetVersionsRequest) Execute() ([]LocationVersion, *http.Response, error) {
...
*/
func (a *VersionsApiService) GetVersions(ctx context.Context, provider string, service string, region string) ApiGetVersionsRequest {
	return ApiGetVersionsRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
func (a *VersionsApiService) GetVersionsExecute(r ApiGetVersionsRequest) ([]LocationVersion, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/providers/{provider}/services/{service}/regions/{region}/versions"
