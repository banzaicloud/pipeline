...
func (r ApiGetProviderRequest) Execute() (*ProviderResponse, *http.Response, error) {
...
*/
func (a *ProviderApiService) GetProvider(ctx context.Context, provider string) ApiGetProviderRequest {
	return ApiGetProviderRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
func (a *ProviderApiService) GetProviderExecute(r ApiGetProviderRequest) (*ProviderResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/providers/{provider}"
