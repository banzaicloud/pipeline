...
func (r ApiGetProvidersRequest) Execute() (*ProvidersResponse, *http.Response, error) {
...
func (a *ProvidersApiService) GetProvidersExecute(r ApiGetProvidersRequest) (*ProvidersResponse, *http.Response, error) {
	var (
