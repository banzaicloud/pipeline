...
*/
func (a *ServiceApiService) GetService(ctx context.Context, provider string, service string) ApiGetServiceRequest {
	return ApiGetServiceRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
func (a *ServiceApiService) GetServiceExecute(r ApiGetServiceRequest) (*ServiceResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/providers/{provider}/services/{service}"
